...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      brand: {
        tagline: "Premium tech, stocked weekly with fast shipping.",
      ...
      auth: {
        ...
        buyer_account_title: "Update buyer account",
        buyer_account_desc: "Change your email or password anytime.",
        buyer_account_submit: "Update account",
        buyer_account_status: "Awaiting input.",
      ...
      chat: {
        title: "Support chat",
        subtitle: "Chat with Techstuf support.",
        close: "Close",
        status_idle: "Sign in to start chat.",
        message_placeholder: "Type your message",
        send: "Send message",
        empty: "No messages yet. Say hello to start the chat.",
        support: "Support",
        auth_missing: "Supabase auth not configured.",
        sign_in_required: "Sign in to start support chat.",
        thread_failed: "Unable to load your chat thread.",
        load_failed: "Could not load messages.",
        ready: "Support online. Send a message.",
        send_failed: "Message failed to send.",
        inbox_title: "Support inbox",
        inbox_desc: "Respond to customer messages.",
        reply_placeholder: "Type a reply",
        inbox_hint: "Select a thread to reply.",
      },
      footer: {
      ...
      cart: {
        ...
        order_summary_note: "A receipt will be sent by PayPal.",
        order_id: "Order",
        order_total: "Total",
        order_email: "Email",
        order_status: "Status",
      ...
      status: {
        ...
        account_update_missing: "Enter a new email or password.",
        account_update_password_short: "Password must be at least 6 characters.",
        account_update_password_mismatch: "Password confirmation does not match.",
        account_update_success: "Update requested. Check your email to confirm changes if prompted.",
      },
      review_form: {
    ...
    ru: {
      ...
      brand: {
        tagline: "Премиальная техника с регулярными поставками и быстрой доставкой.",
      ...
      auth: {
        ...
        buyer_account_title: "Обновить аккаунт покупателя",
        buyer_account_desc: "Меняйте email или пароль в любое время.",
        buyer_account_submit: "Обновить аккаунт",
        buyer_account_status: "Ожидает ввода.",
      ...
      support: {
        ...
        chat_btn: "Открыть чат поддержки",
      ...
      chat: {
        title: "Чат поддержки",
        subtitle: "Пообщайтесь с поддержкой Techstuf.",
        close: "Закрыть",
        status_idle: "Войдите, чтобы начать чат.",
        message_placeholder: "Введите сообщение",
        send: "Отправить",
        empty: "Сообщений нет. Напишите первым.",
        support: "Поддержка",
        auth_missing: "Supabase не настроен.",
        sign_in_required: "Войдите, чтобы открыть чат поддержки.",
        thread_failed: "Не удалось загрузить чат.",
        load_failed: "Не удалось загрузить сообщения.",
        ready: "Поддержка онлайн. Напишите сообщение.",
        send_failed: "Сообщение не отправлено.",
        inbox_title: "Входящие обращения",
        inbox_desc: "Отвечайте на сообщения клиентов.",
        reply_placeholder: "Введите ответ",
        inbox_hint: "Выберите чат, чтобы ответить.",
      },
      footer: {
      ...
      cart: {
        ...
        order_summary_note: "Квитанция будет отправлена PayPal.",
        order_id: "Заказ",
        order_total: "Сумма",
        order_email: "Email",
        order_status: "Статус",
      ...
      status: {
        ...
        account_update_missing: "Введите новый email или пароль.",
        account_update_password_short: "Пароль должен быть не короче 6 символов.",
        account_update_password_mismatch: "Подтверждение пароля не совпадает.",
        account_update_success: "Запрос на обновление отправлен. Проверьте почту.",
      },
      review_form: {
